...
def train_loop(config):
    ...
    train_dataset = Mydataloader.ImageDepthLoader(config.images_path, "/root/Zero-DCE/Zero-DCE_code/data/DepthAndImage/Image/", "/root/Zero-DCE/Zero-DCE_code/data/DepthAndImage/Depth/")
